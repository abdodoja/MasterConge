          ...
          <br>
             ...
             <br>
              ...
              <table class="tab" border="0" style="text-align:center ; margin-left: 20%;">
                ...
                <tr>
                    <td><input class="button" type="submit" name="Demande" value="Enregistrer "style="margin-left: 70%; width: 80px ; height: 35px; font-weight: 700;"  /></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                     <td><input class="button"  type="submit" name="Annule"  value="Annule"  style="margin-left: 70%; width: 80px ; height: 35px; font-weight: 700;"  /></td>
                </tr>  
