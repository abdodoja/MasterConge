           ...
           <div class="info">
                <div>
                 ...
                 <br>
                  ...
                  <table class="tab" border="1" style="text-align:center ; margin-left: 10%; width: 79%; height: 80%;">
                  <tr style=" background-color: rgb(243, 232, 232);">
                        <td>Num Demand</td>
                        <td>Nom Utilisateur </td>
                        <td>Nbr jours </td>
                        <td>Projet </td>
                        <td>Validation Dr.Projet</td>
                     ...
                     <tr>
                        ...
                        <td>Projet1 </td>
                        <td>Oui</td>
                        <td> <input class="button" type="submit" name="Oui"  value="Oui" style=" width: 70px;height: 30px;font-weight: 700;" /></td>
                        <td> <input class="button" type="submit" name="Non"  value="Non" style=" width: 70px;height: 30px;font-weight: 700;" /></td>
